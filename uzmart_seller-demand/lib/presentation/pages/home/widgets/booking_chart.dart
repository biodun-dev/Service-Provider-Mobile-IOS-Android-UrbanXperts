...
class BookingChart extends StatelessWidget {
  final List<num> totalPrice;
  final List<num> canceledPrice;
    ...
    return Padding(
      ...
      child: isLoading
          ...
          : chart.isNotEmpty
              ...
              : Center(
                  child: Text(
                    AppHelpers.getTranslation(TrKeys.needBooking),
  ...
  Widget leftTitleWidgets(double value, TitleMeta meta) {
    ...
    return AutoSizeText(
      AppHelpers.numberFormat(number: totalPrice[value.toInt()]),
      style: style,
