...
class _$CreateFoodDetailsStateImpl extends _CreateFoodDetailsState {
  ...
  @override
  String toString() {
    return 'CreateFoodDetailsState(title: $title, description: $description, tax: $tax, minQty: $minQty, maxQty: $maxQty, qrcode: $qrcode, active: $active, interval: $interval, digital: $digital, ageLimit: $ageLimit, images: $images, isCreating: $isCreating, createdProduct: $createdProduct, listOfUrls: $listOfUrls, mapOfDesc: $mapOfDesc)';
  }
