...
class _$EditFoodStocksStateImpl extends _EditFoodStocksState {
  ...
  @override
  String toString() {
    return 'EditFoodStocksState(isLoading: $isLoading, isSaving: $isSaving, isExtrasSave: $isExtrasSave, isFetchingGroups: $isFetchingGroups, deleteStocks: $deleteStocks, groups: $groups, stocks: $stocks, activeGroupExtras: $activeGroupExtras, localExtras: $localExtras, selectGroups: $selectGroups)';
  }
