...
mixin _$EditFoodDetailsState {
  ...
  bool get digital => throw _privateConstructorUsedError;
...
class _$EditFoodDetailsStateImpl extends _EditFoodDetailsState {
  ...
  @override
  String toString() {
    return 'EditFoodDetailsState(isLoading: $isLoading, active: $active, featureType: $featureType, title: $title, description: $description, minQty: $minQty, maxQty: $maxQty, quantity: $quantity, digital: $digital, ageLimit: $ageLimit, tax: $tax, barcode: $barcode, interval: $interval, images: $images, listOfUrls: $listOfUrls, mapOfDesc: $mapOfDesc, language: $language, product: $product)';
  }
...
abstract class _EditFoodDetailsState extends EditFoodDetailsState {
  const factory _EditFoodDetailsState(
      ...
      final LanguageData? language,
      final ProductData? product}) = _$EditFoodDetailsStateImpl;
