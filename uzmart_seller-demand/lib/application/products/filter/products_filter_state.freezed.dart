...
class _$ProductsFilterStateImpl implements _ProductsFilterState {
  const _$ProductsFilterStateImpl(
      {this.selectType = LayoutType.twoV,
      this.isLoading = true,
      this.type = "category",
      this.filter = null,
  ...
  @override
  String toString() {
    return 'ProductsFilterState(selectType: $selectType, isLoading: $isLoading, type: $type, filter: $filter, filterPrices: $filterPrices, extras: $extras, categories: $categories, brands: $brands, prices: $prices, rangeValues: $rangeValues)';
  }
...
abstract class _ProductsFilterState implements ProductsFilterState {
  const factory _ProductsFilterState(
      ...
      final RangeValues? rangeValues}) = _$ProductsFilterStateImpl;
