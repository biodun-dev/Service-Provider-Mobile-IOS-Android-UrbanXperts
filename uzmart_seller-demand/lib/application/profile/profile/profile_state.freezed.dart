...
class _$ProfileStateImpl extends _ProfileState {
  ...
  @override
  String toString() {
    return 'ProfileState(isLoading: $isLoading, isReferralLoading: $isReferralLoading, isSaveLoading: $isSaveLoading, isLoadingHistory: $isLoadingHistory, typeIndex: $typeIndex, bgImage: $bgImage, logoImage: $logoImage, addressModel: $addressModel, userData: $userData, categoryId: $categoryId)';
  }
...
abstract class _ProfileState extends ProfileState {
  const factory _ProfileState(
      ...
      final AddressData? addressModel,
      final UserData? userData,
      final int? categoryId}) = _$ProfileStateImpl;
