...
class _$EditCategoryStateImpl extends _EditCategoryState {
  ...
  @override
  String toString() {
    return 'EditCategoryState(isLoading: $isLoading, isUpdate: $isUpdate, active: $active, title: $title, input: $input, description: $description, images: $images, imageFile: $imageFile, listOfUrls: $listOfUrls, category: $category)';
  }
...
abstract class _EditCategoryState extends EditCategoryState {
  const factory _EditCategoryState(
      ...
      final CategoryData? category}) = _$EditCategoryStateImpl;
