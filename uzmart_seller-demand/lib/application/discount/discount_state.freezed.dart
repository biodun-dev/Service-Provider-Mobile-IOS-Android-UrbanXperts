...
abstract class $DiscountStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, List<DiscountData> discounts});
}
...
class _$DiscountStateImpl extends _DiscountState {
  const _$DiscountStateImpl(
      {this.isLoading = false, final List<DiscountData> discounts = const []})
  ...
  @override
  String toString() {
    return 'DiscountState(isLoading: $isLoading, discounts: $discounts)';
  }
