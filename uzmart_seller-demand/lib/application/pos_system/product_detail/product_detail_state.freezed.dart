...
class _$ProductDetailStateImpl extends _ProductDetailState {
  ...
  @override
  String toString() {
    return 'ProductDetailState(isLoading: $isLoading, typedExtras: $typedExtras, initialStocks: $initialStocks, selectedIndexes: $selectedIndexes, selectImage: $selectImage, selectedStock: $selectedStock, productData: $productData, paginateResponse: $paginateResponse)';
  }
...
abstract class _ProductDetailState extends ProductDetailState {
  const factory _ProductDetailState(
      ...
      final Stocks? selectedStock,
      final ProductData? productData,
      final PriceData? paginateResponse}) = _$ProductDetailStateImpl;
