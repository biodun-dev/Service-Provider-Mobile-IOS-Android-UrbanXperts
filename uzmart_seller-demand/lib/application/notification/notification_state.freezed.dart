...
mixin _$NotificationState {
  List<NotificationTransactionData> get transaction =>
  ...
  List<NotificationData> get notifications =>
      throw _privateConstructorUsedError;
  CountNotificationData? get countOfNotifications =>
      throw _privateConstructorUsedError;
...
abstract class $NotificationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<NotificationTransactionData> transaction,
      int totalCount,
      bool isTransactionsLoading,
      bool hasMoreTransactions,
      List<NotificationData> notifications,
      CountNotificationData? countOfNotifications,
    ...
    return _then(_value.copyWith(
      transaction: null == transaction
          ...
          : transaction // ignore: cast_nullable_to_non_nullable
              as List<NotificationTransactionData>,
...
class _$NotificationStateImpl extends _NotificationState {
  const _$NotificationStateImpl(
      {final List<NotificationTransactionData> transaction = const [],
      this.totalCount = 0,
  ...
  final List<NotificationTransactionData> _transaction;
  @override
  @JsonKey()
  List<NotificationTransactionData> get transaction {
  ...
  @override
  @JsonKey()
  final CountNotificationData? countOfNotifications;
  @override
  @JsonKey()
...
abstract class _NotificationState extends NotificationState {
  const factory _NotificationState(
      {final List<NotificationTransactionData> transaction,
      final int totalCount,
      final bool isTransactionsLoading,
      final bool hasMoreTransactions,
