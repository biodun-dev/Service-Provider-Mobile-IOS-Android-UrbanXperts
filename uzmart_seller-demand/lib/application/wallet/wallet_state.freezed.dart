...
mixin _$WalletState {
  ...
  bool get isMaksekeskusLoading => throw _privateConstructorUsedError;
...
abstract class $WalletStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? selectMethodLink,
      List<UserData>? listOfUser,
      bool isMaksekeskusLoading,
      MaksekeskusData? maksekeskus,
...
class _$WalletStateCopyWithImpl<$Res, $Val extends WalletState>
  ...
  $Res call({
    ...
    Object? isMaksekeskusLoading = null,
    ...
    return _then(_value.copyWith(
      ...
      listOfUser: freezed == listOfUser
          ...
          : listOfUser // ignore: cast_nullable_to_non_nullable
              as List<UserData>?,
      isMaksekeskusLoading: null == isMaksekeskusLoading
          ? _value.isMaksekeskusLoading
          : isMaksekeskusLoading // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$WalletStateImpl implements _WalletState {
  const _$WalletStateImpl(
      ...
      this.isMaksekeskusLoading = false,
  ...
  @override
  @JsonKey()
  final bool isMaksekeskusLoading;
  @override
  @JsonKey()
  ...
  @override
  String toString() {
    return 'WalletState(isTransactionLoading: $isTransactionLoading, isButtonLoading: $isButtonLoading, isSearchingLoading: $isSearchingLoading, selectPayment: $selectPayment, list: $list, selectMethodLink: $selectMethodLink, listOfUser: $listOfUser, isMaksekeskusLoading: $isMaksekeskusLoading, maksekeskus: $maksekeskus, transactions: $transactions)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isMaksekeskusLoading, isMaksekeskusLoading) ||
                other.isMaksekeskusLoading == isMaksekeskusLoading) &&
...
abstract class _WalletState implements WalletState {
  const factory _WalletState(
      ...
      final String? selectMethodLink,
      final List<UserData>? listOfUser,
      final bool isMaksekeskusLoading,
      final MaksekeskusData? maksekeskus,
      final List<TransactionModel> transactions}) = _$WalletStateImpl;
