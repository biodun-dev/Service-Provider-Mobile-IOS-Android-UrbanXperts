...
class _$ResetPasswordStateImpl extends _ResetPasswordState {
  ...
  @override
  String toString() {
    return 'ResetPasswordState(isLoading: $isLoading, isSuccess: $isSuccess, showPassword: $showPassword, showConfirmPassword: $showConfirmPassword, email: $email, phone: $phone, verificationId: $verificationId, verifyId: $verifyId)';
  }
