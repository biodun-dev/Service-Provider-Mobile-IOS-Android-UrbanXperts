...
class _$AuthStateImpl extends _AuthState {
  const _$AuthStateImpl({this.selectIndex = 0}) : super._();
  ...
  @override
  String toString() {
    return 'AuthState(selectIndex: $selectIndex)';
  }
...
abstract class _AuthState extends AuthState {
  const factory _AuthState({final int selectIndex}) = _$AuthStateImpl;
